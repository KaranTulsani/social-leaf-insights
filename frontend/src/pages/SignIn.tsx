  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (registeredUserStr) {
      ...
      if (registeredUser.email === email && registeredUser.password === password) {
        ...
        localStorage.setItem("access_token", "mock_token_for_demo"); // Add mock token
        localStorage.setItem("currentUser", JSON.stringify({ name: registeredUser.name, email: registeredUser.email }));
        navigate("/dashboard");
        return;
      }
    }
